        ...
        >
          ...
          <div class="mt-6 pt-5 border-t border-slate-200/80 flex flex-col gap-3 pb-2">
            ...
            <div class="rounded-xl border border-gold-500/20 bg-gold-50/60 p-3 text-xs text-slate-600 flex items-center gap-2.5">
              <span class="flex h-7 w-7 flex-none items-center justify-center rounded-full bg-gold-500/15 text-gold-600">
                <svg viewBox="0 0 24 24" class="h-4 w-4 fill-current">
                  <path d="M13 2L3 14h9l-1 8 10-12h-9l1-8z" />
                </svg>
              </span>
              <p class="leading-snug">
                <span class="font-bold text-slate-900">Devis gratuit sous 15 min</span> · Parakou
              </p>
            </div>
