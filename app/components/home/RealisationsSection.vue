...
const projects: RealisationProject[] = [
  {
    id: 'studio',
    title: 'Nettoyage Séjour & Espace Repas — Parakou',
    category: 'Studio & Séjour',
    location: 'Quartier Titirou, Parakou',
    before: '/images/realisations/sejour_before.jpg',
    after: '/images/realisations/sejour_after.jpg',
    description: 'Dépoussiérage intégral du mobilier, décapage et lustrage minutieux du carrelage pour un sol éclatant et propre.',
    duration: '2h30',
    teamSize: '2 agents',
  ...
  {
    id: 'cuisine',
    title: 'Rénovation & Nettoyage Cuisine Complète',
    category: 'Cuisine',
    location: 'Centre-ville, Parakou',
    before: '/images/realisations/cuisine_before.jpg',
    after: '/images/realisations/cuisine_after.jpg',
    description: 'Dégraissage complet de l\'évier inox, désinfection des surfaces et placards, élimination des graisses tenaces.',
    duration: '3 heures',
    teamSize: '2 agents',
  ...
  {
    id: 'sanitaires',
    title: 'Désinfection Salle d\'Eau & Lavabo',
    category: 'Sanitaires',
    location: 'Quartier Ladji Farani, Parakou',
    before: '/images/realisations/salle_de_bain_before.jpg',
    after: '/images/realisations/salle_de_bain_after.jpg',
  ...
  {
    id: 'couloir',
    title: 'Lavage & Lustrage Couloir de Circulation',
    category: 'Sols & Couloir',
    location: 'Quartier Albarika, Parakou',
    before: '/images/realisations/couloir_before.jpg',
    after: '/images/realisations/couloir_after.jpg',
    description: 'Élimination des saletés et poussières incrustées sur carrelage, séchage soigné et brillance durable sans traces.',
    duration: '2 heures',
    teamSize: '2 agents',
      ...
      <div class="lg:col-span-4 rounded-3xl border border-slate-200/80 bg-white p-6 sm:p-8 shadow-xl flex flex-col justify-between space-y-6">
        ...
        <div class="space-y-3 pt-2">
          <a
            ...
            target="_blank"
            rel="noopener"
            class="btn-gold w-full text-center text-xs sm:text-sm !py-3 flex items-center justify-center"
          >
